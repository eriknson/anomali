      ...
      <div className="header">
        ...
        <div className="header-description">
          ...
          <p>
            ...
            concept tool to assess weak spots (in terms of time table
            deviations) using graph theory.
          </p>
          <p>
            ...
            legend by clicking on the second button in the top-right corner of
            the map.
          </p>
          <p>
